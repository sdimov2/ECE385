...
# setting SOPC_SYSID_BASE_ADDRESS is 0x60
SOPC_SYSID_FLAG += --sidp=0x60
ELF_PATCH_FLAG  += --sidp 0x60

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1635187079
SOPC_SYSID_FLAG += --timestamp=1635187079
ELF_PATCH_FLAG  += --timestamp 1635187079
