...
module lab61soc_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> switches_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> buttons_s1_agent:cp_data
	...
	wire  [103:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [103:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_009:sink_data
	...
	lab61soc_mm_interconnect_0_router_006 router_007 (
	...
	lab61soc_mm_interconnect_0_router_008 router_008 (
	...
	lab61soc_mm_interconnect_0_router_006 router_009 (
	...
	lab61soc_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
