	GuitarHero u0 (
		...
		.vga_conduit_drawx              (<connected-to-vga_conduit_drawx>),              //             vga_conduit.drawx
		.vga_conduit_drawy              (<connected-to-vga_conduit_drawy>),              //                        .drawy
		.vga_conduit_reg_idx            (<connected-to-vga_conduit_reg_idx>)             //                        .reg_idx
	);
