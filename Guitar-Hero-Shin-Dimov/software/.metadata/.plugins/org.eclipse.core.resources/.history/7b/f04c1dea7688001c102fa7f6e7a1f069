...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../GuitarHero.sopcinfo
...
# Design Name 
# setting SOPC_NAME is GuitarHero
SOPC_NAME := GuitarHero
...
# The SOPC System ID 
# setting SOPC_SYSID is 255
SOPC_SYSID_FLAG += --id=255
ELF_PATCH_FLAG  += --id 255
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1639338139
SOPC_SYSID_FLAG += --timestamp=1639338139
ELF_PATCH_FLAG  += --timestamp 1639338139
