...
struct TEXT_VGA_STRUCT {
	...
	// We're going to make a different struct for Palette
};

struct TEXT_VGA_PALETTE {
	alt_u8 PALETTE [32]; // 16 colors addressed by AVL_ADDR
};
...
static volatile struct TEXT_VGA_STRUCT* vga_ctrl = VGA_ATTEMPT_3_0_BASE;

//static volatile struct TEXT_VGA_PALETTE* vga_palette = VGA_ATTEMPT_3_0_BASE + 0x2000;
// Not setting palettes for now
