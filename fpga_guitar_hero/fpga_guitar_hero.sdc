...
create_clock -period "50.0 MHz" [get_ports MAX10_CLK1_50] -name clk_main
...
create_generated_clock [get_nets {u0|vga_text_mode_controller_0|m_vga_controller|clkdiv}] \
							-divide_by 2 -source [get_ports {MAX10_CLK1_50}] -name vga_clk
...
set_output_delay -clock vga_clk 0 [get_ports VGA_*]
#**************************************************************
# Set Clock Groups
#**************************************************************
