...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../fpga_guitar_hero_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is fpga_guitar_hero_soc
SOPC_NAME := fpga_guitar_hero_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001890
SOPC_SYSID_FLAG += --sidp=0x8001890
ELF_PATCH_FLAG  += --sidp 0x8001890

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1637129130
SOPC_SYSID_FLAG += --timestamp=1637129130
ELF_PATCH_FLAG  += --timestamp 1637129130
