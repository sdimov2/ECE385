...
# Memory: chip_ram
MEM_0 := fpga_guitar_hero_soc_chip_ram
$(MEM_0)_NAME := chip_ram
...
$(MEM_0)_START := 0x08040000
$(MEM_0)_END := 0x080670ff
$(MEM_0)_SPAN := 0x00027100
$(MEM_0)_HIERARCHICAL_PATH := chip_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: chip_ram
chip_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
