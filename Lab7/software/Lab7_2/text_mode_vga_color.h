...
static volatile struct TEXT_VGA_STRUCT* vga_ctrl = VGA_TEXT_CONTROLLER_0_BASE;

static volatile struct TEXT_VGA_PALETTE* vga_palette = VGA_TEXT_CONTROLLER_0_BASE + 0x2000;
